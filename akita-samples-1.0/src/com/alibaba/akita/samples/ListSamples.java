...
public class ListSamples extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String path = intent.getStringExtra("com.alibaba.akita.sample.PATH");
    ...
    protected List<Map<String, Object>> getData(String prefix) {
        ...
        mainIntent.addCategory("com.alibaba.akita.sample.SAMPLE");
    ...
    protected Intent browseIntent(String path) {
        ...
        result.putExtra("com.alibaba.akita.sample.PATH", path);
        return result;
    }
