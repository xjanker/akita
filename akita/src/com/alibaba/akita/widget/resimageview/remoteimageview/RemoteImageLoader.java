...
package com.alibaba.akita.widget.resimageview.remoteimageview;
...
public class RemoteImageLoader {
    ...
    /**
     * Creates a new ImageLoader that is backed by an {@link com.alibaba.akita.cache.FilesCache< android.graphics.Bitmap>}. The cache will by default
     * cache to the device's external storage, and expire images after 1 day. You can set useCache
     * to false and then supply your own remoteimageview cache instance via {@link #setImageCache(com.alibaba.akita.cache.FilesCache< android.graphics.Bitmap>)}
     * , or fine-tune the default one through {@link #getImageCache()}.
     *
     * @param context
     *            the current context
     * @param createCache
     *            whether to create a default {@link com.alibaba.akita.cache.FilesCache< android.graphics.Bitmap>} used for caching
     */
     ...
     *
     * @return the {@link com.alibaba.akita.cache.FilesCache< android.graphics.Bitmap>}
     */
